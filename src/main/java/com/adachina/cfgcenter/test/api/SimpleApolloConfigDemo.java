package com.adachina.cfgcenter.test.api;
...
public class SimpleApolloConfigDemo {
  ...
  public SimpleApolloConfigDemo() {
    ...
    otherConfig = ConfigService.getConfig("config-namespace");
    config.addChangeListener(changeListener);
    otherConfig.addChangeListener(changeListener);
  }

  private String getConfig(String key) {
    String result = config.getProperty(key, DEFAULT_VALUE);
    if (DEFAULT_VALUE.equals(result)) {
      result = otherConfig.getProperty(key, DEFAULT_VALUE);
    }
