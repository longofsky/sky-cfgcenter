package com.adachina.cfgcenter.config.localize;
...
import com.adachina.cfgcenter.config.processor.LocalServerPorpertySourcesProcessor;
import com.ctrip.framework.apollo.spring.util.BeanRegistrationUtil;
import com.adachina.cfgcenter.config.processor.context.EnvironmentContextProcessor;
...
public class LocalizeFileLoader implements BeanFactoryPostProcessor, EnvironmentAware, BeanDefinitionRegistryPostProcessor {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) {
        ...
        BeanRegistrationUtil.registerBeanDefinitionIfNotExists(registry, BaseGenericConfig.class.getName(), BaseGenericConfig.class);
